...
const getGitHubUsername = () => {
  return (
    process.env.GITHUB_PROJECTS_USER ??
      ...
      content: (
        <>
          <p className="mt-2 leading-relaxed text-gray-300">
            I have worked on countless projects over the past five years, for
            the most part. I started learning to code with Python when I was
            seven and my interest has only evolved from there. I got into web
            development due to my uncle, who taught my how to write my first
            lines of HTML.
          </p>
          <p className="mt-2 leading-relaxed text-gray-300">
            Recently, I have been involved in developing several projects,
            especially with TypeScript, which is my new favorite language as of
            a year ago. My biggest project currently is{' '}
            <Link href="https://p0ntus.com/">p0ntus</Link>, a free service
          ...
          <p className="mt-2 leading-relaxed text-gray-300">
            ...
            <Link href="https://github.com/abocn">ABOCN</Link>, where we
            primarily maintain a Telegram bot called{' '}
            <Link href="https://github.com/abocn/TelegramBot">Kowalski</Link>.
            You can find it on Telegram as{' '}
      ...
      content: (
        <>
          ...
          <p className="mt-2 leading-relaxed text-gray-300">
            ...
            lot of time to it. I genuinely enjoy installing Arch, Gentoo, and
            NixOS frequently, and flashing new ROMs to the phones I own.
          </p>
          <p className="mt-2 leading-relaxed text-gray-300">
            I am frequently active on{' '}
            <Link href="https://git.p0ntus.com/">my Forgejo server</Link> and
          ...
          <p className="mt-2 leading-relaxed text-gray-300">
            ...
            Boston, Massachusetts. I also used to swim competitively, though it
            has turned into to a casual hobby over time.
          </p>
          <p className="mt-2 leading-relaxed text-gray-300">
            Editing Wikipedia has also been a good pastime for me, and I have
            been editing for a year and a half now. As of writing, I have made
            6.1k edits to the English Wikipedia. I am also an{' '}
            <Link href="https://en.wikipedia.org/wiki/Wikipedia:WikiProject_Articles_for_creation">
              AfC
            </Link>{' '}
            reviewer, new page reviewer, and rollbacker. You can find me on
            Wikipedia as{' '}
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <h3 className="mt-4 mb-2 text-xl font-semibold text-gray-200">
            Laptops
          </h3>
          <p className="mt-2 leading-relaxed text-gray-300">
            I currently daily-drive with a 16-inch MacBook Pro with an M4 Max,
            64GB of memory, 2TB of storage, 16 core CPU, and a 40 core GPU.
          </p>
          <p className="mt-2 leading-relaxed text-gray-300">
            I use a Lenovo Thinkpad T470s with macOS Sequoia (using{' '}
            <Link href="https://github.com/acidanthera/OpenCorePkg">
              OpenCore
            </Link>
          ...
          <p className="mt-2 leading-relaxed text-gray-300">
            ...
            Chromebook, used as secondary devices. The 2013 runs unsupported
            macOS Sequoia Beta, the 2015 runs{' '}
            <Link href="https://xubuntu.org/">Xubuntu</Link>, and the Chromebook
            runs Arch Linux.
          </p>
        </>
      )
